...
export default function HomePage() {
  ...
  return (
    <>
      {/* Load the native Mux web component early (same source as Mux docs demo) */}
      <Script
      ...
      <div className="min-h-screen">
        {/* ---------------- Hero: fills first viewport exactly ---------------- */}
        <section id="hero" className="relative overflow-hidden">
          {/* Direct <mux-player>; ::part(media) in CSS forces true cover */}
          {/* @ts-expect-error custom element */}
          <mux-player
            stream-type="on-demand"
            playback-id="SJtMmzbwrupZu5LYsvhGuKvb8OtU9ErFM8BnwXsrF0200"
            loop
            muted
            autoplay
            playsinline
          ...
          {/* Soft gradient overlay to keep text readable (z-10) */}
            ...
            <div className="text-center max-w-4xl w-full">
              <div className="mb-[2vh]">
                <Image
                  ...
                  style={{ height: 'clamp(400px, 60vmin, 1000px)' }}
                  priority
                />
              </div>
              ...
              <div className="space-y-[1vh]">
                ...
                <h3
                  ...
                  style={{
                    fontFamily: 'Raleway, sans-serif',
                    fontSize: 'clamp(1.5rem, 3vmin, 2.7rem)',
                  }}
                >
                  COSTA RICA
                </h3>
                ...
                <p
                  ...
                  style={{
                    fontFamily: 'Raleway, sans-serif',
                    fontSize: 'clamp(1.35rem, 2.7vmin, 2.1rem)',
                  }}
                >
            ...
            <div className="mt-[3vh]">
              <div className="animate-bounce">
                <svg
                  ...
                  style={{
                    width: 'clamp(24px, 2.5vmin, 32px)',
                    height: 'clamp(24px, 2.5vmin, 32px)',
                  }}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
